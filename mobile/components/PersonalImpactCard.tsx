...
export const PersonalImpactCard: React.FC<PersonalImpactCardProps> = ({ token }) => {
    ...
    return (
        <View style={styles.card}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Personal Impact Tracking</Text>
            </View>
            ...
            <View style={styles.chipsContainer}>
                {subscriptions.filter(s => s.topic).map(sub => (
                    <View key={sub.id} style={styles.chip}>
                        <MaterialCommunityIcons name="lightning-bolt" size={14} color="#0ca678" />
